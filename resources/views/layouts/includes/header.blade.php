...
$pending=Order::orderBy('id','desc')->where('status','pending')->get();
@endphp
     ...
     <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
             ...
             <li class="dropdown messages-menu">
                ...
                <span class="label label-primary">{{$pending->count()}}</span>
                </a>
                   ...
                   <li>
                      <ul class="menu">
                        @forelse($pending as $order)
                         <li >
                            <!-- start Orders -->
                            <a href="{{url('admin/view-order/item',$order->id)}}" class="border-gray">
                               <div class="pull-left">
             ...
             <li class="dropdown notifications-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id='markasread'>
                ...
                <ul class="dropdown-menu">
                   <li>
                      <ul class="menu">
                        <li><a href="#" class="border-gray" style="background:white">Unread Notification</a></li>
                   ...
                   <li>
                    <ul class="menu">
                      <li><a href="#" class="border-gray" style="background:white">Read Notification</a></li>
