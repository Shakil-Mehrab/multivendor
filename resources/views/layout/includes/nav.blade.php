    ...
    <div class="header-middle">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="dropdown cart-dropdown" id="cartBasket">
                    <!-- cart by ajax -->
                </div>
            </div><!-- End .header-right -->
        </div><!-- End .container -->
            ...
            <nav class="main-nav">
                <ul class="menu sf-arrows">
                    ...
                    if(Auth::check()){
                        ...
                        if($shop){
                        if($shop->is_active==1){
                             echo '<li class="float-right"><a href="/dashboard"><i class="fas fa-plus-square"></i> Create Product</a></li>';
                        }else{
                        echo '<li class="float-right"><a href="#" style="color: red"><i class="fas fa-envelope-square"></i> Wait for Shop Confirmation</a></li>';
                        }
                        }else{
                        echo '<li class="float-right"><a href="/admin/add-shop"><i class="fas fa-plus-square"></i> Create Shop</a></li>';
                        }
                    }
                    @endphp
                </ul>
