       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" action="{{url('/admin/add-country')}}" method="post" enctype="multipart/form-data"> {{csrf_field()}}
                      <div class="form-group">
                         <label>Country Name</label>
                         <input type="text" class="form-control" placeholder="Enter Counry Name" name="name" id="name" required>
                      </div>
                      <div class="form-group">
                         <label>Code</label>
