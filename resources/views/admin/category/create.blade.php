       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" action="{{url('/admin/add-category')}}" method="post" enctype="multipart/form-data"> {{csrf_field()}}
                      ...
                      <div class="form-group">
                        <label>Slug</label>
                        <input type="text" class="form-control" placeholder="Enter Category Slug" name="category_slug" id="category_slug" required>
                     </div>
                      <div class="form-group">
