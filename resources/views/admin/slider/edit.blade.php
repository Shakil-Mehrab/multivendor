             ...
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/edit-slide/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Name" value="{{$productDetails->name}}" name="name" id="name" required>
                 </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <select name="position" id="position" class="form-control" required>
                        ...
                        <option value="left" {{$productDetails->position=='left'?'selected':''}}>Left</option>
                        <option value="right" {{$productDetails->position=='right'?'selected':''}}>Right</option>
                    </select>
                 </div>
                 <div class="form-group">
